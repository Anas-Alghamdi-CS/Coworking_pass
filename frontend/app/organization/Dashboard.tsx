...
import { CalendarDays, MapPin, Star, Clock, ArrowRight, Bookmark, Check, Users, Building2, Presentation, Clapperboard } from 'lucide-react';
import { useApp } from '@/app/store';
import { Space, getEffectiveSpacePrice, Booking, getHourlyPriceForDuration, Employee, getBookingPrice, getSpaceCategory, SpaceCategory } from '@/types/types';
